...
| --- | ---: | ---: | ---: | ---: | --- |
| `group_b_bundle_018` | 669.3 ms | 754.2 ms (`split_union_distinct_countstar`/`agg_pd_hash16`) | 783.9 ms | 767,762 | Manual data-model/pre-aggregation optimization needed |
| `group_b_bundle_020` | 1128.5 ms | 1143.0 ms (`split_union_distinct_countstar`/`distinct_pd_hash16`) | 1133.3 ms | 1,559,443 | Manual data-model/pre-aggregation optimization needed |
...
- Original baseline: `1495.0 ms`
- Current optimized exact best: `669.3 ms`, variant `optimized_distinct_pushdown`
...
- Original baseline: `3034.6 ms`
- Current optimized exact best: `1128.5 ms`, variant `optimized_distinct_pushdown_hashagg_16_8`
